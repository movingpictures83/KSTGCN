...
from plugins.KSTGCN.utils import calculate_laplacian
...
class ktgcnCell(RNNCell):
    ...
    def __init__(self, inputfile,  num_units, adj, num_nodes, time_len, dim, input_size=None,
    ...
    def _gc(self, inputs, state, output_size, bias=0.0, scope=None):
        kgembedding = pd.read_csv(self.inputfile+"/sz_kg_embedding.csv",header = None)
